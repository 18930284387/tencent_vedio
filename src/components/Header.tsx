...
import { searchVideos, videos } from '../data';
...
const Header: React.FC<HeaderProps> = ({ activeTab, onTabChange, onVideoSelect }) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [showSearchResults, setShowSearchResults] = useState(false);
  const searchRef = useRef<HTMLDivElement>(null);
  const searchedVideos = searchQuery ? searchVideos(videos, searchQuery) : [];
